...
export default function DevelopmentPage() {
  return (
    <>
      <Head>
        <title>Programación — RubnPneal</title>
        <meta
          name="description"
          content="Proyectos de software y perfil técnico de RubnPneal."
        />
      </Head>
        ...
        <SectionLayout eyebrow="Software" title="Programación">
          <div className="grid gap-10 border-t border-white/15 pt-8 lg:grid-cols-[1.3fr_0.7fr] lg:gap-20">
            ...
            <p className="max-w-xl text-base leading-7 text-white/60 lg:pt-2">
              El foco está en la arquitectura, el comportamiento de la aplicación y una
              interfaz clara. Los proyectos de esta selección son software funcional, no
              demos visuales aisladas.
            </p>
          </div>
        </SectionLayout>
              ...
              <div className="border-t border-white/15">
                {capabilities.map(([title, value]) => (
                  ...
                  >
                    ...
                    <span className="text-sm leading-6 text-white/55">{value}</span>
                  </div>
                ))}
                <a
