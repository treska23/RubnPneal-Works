...
export default class FightScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add.image(400, 300, 'room_bg').setDisplaySize(800, 600).setScrollFactor(0);
    ...
    this.drawHealthBar(this.playerHealthBar, 20, 20, this.player.health, this.player.maxHealth);
    this.drawHealthBar(this.enemyHealthBar, 580, 20, this.enemy.health, this.enemy.maxHealth);

    this.startRoundCountdown();

    this.player.on('healthChanged', (hp: number) => {
      this.drawHealthBar(this.playerHealthBar, 20, 20, hp, this.player.maxHealth);
    ...
    this.enemy.on('healthChanged', (hp: number) => {
      this.drawHealthBar(this.enemyHealthBar, 580, 20, hp, this.enemy.maxHealth);
